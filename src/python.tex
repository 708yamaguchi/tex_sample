...
\figref{figure:5dof}右は障害物を飛び越えるような軌道が生成されるという失敗例です。
\figref{figure:5dof}中と比べても障害物の位置が(0.1, 0.1)しかズレていないのに結果が大きく変わってしまい、安定的に収束させることの難しさを実感しました。
